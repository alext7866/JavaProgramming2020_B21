...
public class DivideTwoNumbers {
    ...
    public static void main(String[] args) {
        ...
        int count = 0;  // number of times that we can subtract b from a
...
/* 4. write a program that can divide two numbers without using / & % operators and retuns the devision and remainder
        ...
        10 / 3 = 3.3333....
				...
				AS LONG AS NUMERATOR IS GREATER THAN DENOMINATOR, DENOMINATOR CAN BE SUBTRACTED FROM NUMERATOR.
				 WHATEVER WE HAVE LEFT IN THE NUMERATOR
