...
// toString:
      int[] numbers = {1,2,3,4,5,6};
        ...
        String[] classMates = {"sladjan", "Natalia", "Alex", "Bob", "Rob"};
        System.out.println(  classMates);  //hascode
        System.out.println(Arrays.toString(classMates));


        //sort(array)

        int[] arr1 = {200000, 1000000, 400000,5000000,100000000,300000};

        Arrays.sort(arr1);   // does not oreturn any value, cannot be assigned to a variable
