...
public class TravelTask {
    ...
    public static void main(String[] args) {
        ...
        if(validPassport.equalsIgnoreCase("yes")){
            ...
            System.out.println("Your ticket is booked to " + country + ". We have charged extra for the " + bags + " bags but you are traveling with " + numOfPeople + " so we are giving a discount. Your total cost is " + cost);
